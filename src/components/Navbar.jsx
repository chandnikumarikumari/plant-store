...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-15 py-4 bg-flora-bg/85 backdrop-blur-md border-b border-flora-border"
        ...
        <div className="flex items-center gap-4">
          <button className="hidden md:block bg-transparent border-none text-flora-muted hover:text-white cursor-pointer text-lg transition-colors">🔍</button>
          <button className="relative bg-flora-green hover:bg-flora-glow text-white rounded-full w-10 h-10 flex items-center justify-center cursor-pointer border-none transition-colors text-base">
            🛒
